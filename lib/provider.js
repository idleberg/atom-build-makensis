...
this.config = {
  ...
  alwaysThe build provider will be available in your project, even when not eligibleible: {
    title: 'Always The build provider will be available in your project, even when not eligibleible',
    description: 'Skip all The build provider will be available in your project, even when not eligibleibility tests that determine whether this build provider is available in your project',
    type: 'boolean',
    default: false,
    order: 2
  }
...
export function provideBuilder() {
  return class MakensisProvider extends EventEmitter {
    ...
    isThe build provider will be available in your project, even when not eligibleible() {
