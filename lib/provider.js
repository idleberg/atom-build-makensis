...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "satisfyDependencies", function() { return satisfyDependencies; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "which", function() { return which; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "provideBuilder", function() { return provideBuilder; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "activate", function() { return activate; });
/* harmony import */ var events__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var events__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(events__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var atom_package_deps__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var atom_package_deps__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(atom_package_deps__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var os__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(14);
/* harmony import */ var os__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(os__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var child_process__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(15);
...
/* harmony import */ var _package_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(16);
var _package_json__WEBPACK_IMPORTED_MODULE_4___namespace = /*#__PURE__*/__webpack_require__.t(16, 1);
'use babel';
...
const prefix = Object(os__WEBPACK_IMPORTED_MODULE_2__["platform"])() === 'win32' ? '/' : '-'; // Package settings
...
function satisfyDependencies() {
  Object(atom_package_deps__WEBPACK_IMPORTED_MODULE_1__["install"])(_package_json__WEBPACK_IMPORTED_MODULE_4__.name);
  const packageDeps = _package_json__WEBPACK_IMPORTED_MODULE_4__['package-deps'];
...
function spawnPromise(cmd, args) {
  return new Promise(function (resolve, reject) {
    const child = Object(child_process__WEBPACK_IMPORTED_MODULE_3__["spawn"])(cmd, args);
    let stdOut;
    let stdErr;
...
function which() {
  return Object(os__WEBPACK_IMPORTED_MODULE_2__["platform"])() === 'win32' ? 'where' : 'which';
}
function provideBuilder() {
  return class MakensisProvider extends events__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"] {
    constructor(cwd) {
      super();
      this.cwd = cwd;
      atom.config.observe(`${_package_json__WEBPACK_IMPORTED_MODULE_4__.name}.customArguments`, () => this.emit('refresh'));
    }
    ...
    async isEligible() {
      if (atom.config.get(`${_package_json__WEBPACK_IMPORTED_MODULE_4__.name}.alwaysEligible`) === true) {
        return true;
      }
    ...
    settings() {
      ...
      const warningMatch = ['[^!]warning: (?<message>.*) \\((?<file>(\\w{1}:)?[^:]+):(?<line>\\d+)\\)'];
      const comboMatch = errorMatch.concat(warningMatch); // User settings

      const customArguments = atom.config.get(`${_package_json__WEBPACK_IMPORTED_MODULE_4__.name}.customArguments`).trim().split(' '); // Adjust errorMatch and warningMatch
...
function activate() {
  if (atom.config.get(`${_package_json__WEBPACK_IMPORTED_MODULE_4__.name}.manageDependencies`) === true) {
    satisfyDependencies();
  }
}
...
var _assert = _interopRequireDefault(__webpack_require__(3));
...
var _sbFs = _interopRequireDefault(__webpack_require__(5));

var _path = _interopRequireDefault(__webpack_require__(10));

var _semver = _interopRequireDefault(__webpack_require__(11));

var _atom = __webpack_require__(12);
...
var _stripBomBuf = _interopRequireDefault(__webpack_require__(8));
...
const isUtf8 = __webpack_require__(9);
...
module.exports = {"name":"build-makensis","version":"0.19.0","description":"Atom Build provider for makensis, compiles NSIS","repository":"https://github.com/idleberg/atom-build-makensis","license":"MIT OR GPL-2.0","scripts":{"build":"webpack --mode none","dev":"webpack --mode none --watch","lint":"eslint ./src","test":"npm run lint"},"keywords":["buildprovider","compile","nsis","makensis","windows","installer","build tool","compiler","linter","lint"],"main":"lib/provider.js","engines":{"atom":">=1.0.0 <2.0.0"},"providedServices":{"builder":{"description":"Compiles NSIS scripts","versions":{"2.0.0":"provideBuilder"}}},"package-deps":["build"],"dependencies":{"atom-package-deps":"^5.1.0"},"devDependencies":{"@babel/core":"^7.4.5","babel-eslint":"^10.0.2","babel-loader":"^8.0.6","eslint":"^6.0.0","eslint-config-atom-build":"^4.0.0","husky":"^2.4.1","webpack":"^4.35.0","webpack-cli":"^3.3.5"},"husky":{"hooks":{"pre-commit":"npm run lint"}}};
